...
export default function HostResults({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-violet-900 to-indigo-900 flex flex-col font-[var(--font-nunito)]">
      ...
      {/* Answer options with distribution */}
      <div className="flex-1 px-8 py-4 grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span
                  className={[
                    ...
                    isCorrect ? 'text-white' : 'text-white/70',
                  ].join(' ')}
                >
                  {option.answer_text}
                </span>
                <span
                  className={[
                    'text-xl font-extrabold ml-auto flex-shrink-0',
                ...
                <div className="relative h-4 bg-white/10 rounded-full overflow-hidden">
                  <div
                    className={[
                      ...
                      isCorrect ? config.bg : 'bg-white/30',
                    ].join(' ')}
      ...
      <div className="px-8 pb-4 text-center">
        <p className="text-white/50 text-lg">
          ...
          <span className="text-white font-bold">{players.length}</span> players
          answered
        </p>
      </div>
