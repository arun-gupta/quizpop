...
- [ ] Wrong`}</pre>
          <div className="space-y-2 text-gray-400">
            ...
            <p><span className="text-white font-medium">&gt; type: poll</span> — opinion vote, no correct answer; all options use <code className="text-gray-300">- [ ]</code>; everyone gets full participation points</p>
