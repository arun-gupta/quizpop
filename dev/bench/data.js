    ...
    "QuizPop API Latency": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d3294b488755a90d5164169d015e94526427dccb",
          "message": "Fix overwrite deleting all duplicate quizzes by title\n\nmaybeSingle() fails when multiple rows exist; replace with a bulk\ndelete so re-importing cleans up all duplicates in one shot.\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-05-26T18:06:31-07:00",
          "tree_id": "bea9cf1924eb02abc53db6eee228df83aa3fe5e5",
          "url": "https://github.com/arun-gupta/quizpop/commit/d3294b488755a90d5164169d015e94526427dccb"
        },
        "date": 1779844057570,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "42aa5c3732e41504db1a3876857499cab2515297",
          "message": "Fix host images cropping by switching to object-contain\n\nReplace fixed-height fill+object-cover containers with natural-size\nimg elements capped at 28vh, so full photos are always visible.\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-05-26T20:04:58-07:00",
          "tree_id": "dc63d828d1e7c080f23f8804c9c102b8518d7b9a",
          "url": "https://github.com/arun-gupta/quizpop/commit/42aa5c3732e41504db1a3876857499cab2515297"
        },
        "date": 1779851167480,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "dbfc905b0386536f5c387f0a6fe40e79e73d6ad1",
          "message": "Fix results screen showing submission count instead of player count\n\nPass respondedPlayerIds.size (distinct players) to HostResults so\nopen-text questions with multiple submissions per player show the\ncorrect 'X of Y players answered' count.\n\nCo-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-05-26T20:13:09-07:00",
          "tree_id": "e135f6d5d1b3c75443ac03bf875631f30ab1708e",
          "url": "https://github.com/arun-gupta/quizpop/commit/dbfc905b0386536f5c387f0a6fe40e79e73d6ad1"
        },
        "date": 1779851653309,
        "tool": "customSmallerIsBetter",
        "benches": [
